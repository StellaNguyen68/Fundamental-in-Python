...
- Keyword argument (tham số từ khóa | named parameter )
- Default argument (tham số mặc định| optional parameter: T.số tùy chọn )
...
#Tham số từ khóa: truyền tham số theo tên, không theo vị trí đã khai báo
def cong_ba_so(a, b, c):
    tong = a+b+c
    return tong

# tg = cong_ba_so(5, 9, 10)   # a=5, b=9, c=10
